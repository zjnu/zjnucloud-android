...
public class SlxxDetail extends BaseNewsDetail implements Serializable{
    ...
    public SlxxDetail(String content, long id, int infoGeneralId, String infoGeneralName, int infoTypeId, String infoTypeName, String time, String title, String username, long visit) {
